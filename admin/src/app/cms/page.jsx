...
import { GripVertical, Image as ImageIcon, Plus, Save } from "lucide-react";
      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage the content and layout of your store&apos;s homepage.
          </p>
        </div>
        ...
        <TabsContent value="sections" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Drag and drop to reorder the sections on your homepage.
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="hero">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage the main sliding banners at the top of the homepage.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex space-x-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        defaultValue="https://res.cloudinary.com/mip/diwali-banner-2024.jpg"
                        className="w-[400px]"
                      />
                    </div>
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4 max-w-2xl">
              <div className="space-y-2">
                ...
                <Input
                  id="seo-title"
                  defaultValue="MIP Jewellers | Premium Gold & Diamond Collections"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="seo-desc"
                  defaultValue="Discover our exclusive collection of 22K gold, diamond, and platinum jewellery. Shop online or visit our stores."
                />
              </div>
            </CardContent>
          </Card>
