    ...
    <div className="flex-1 space-y-8 p-6 md:p-10 bg-[#FAF8F5] min-h-screen font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#DED8D0] pb-6">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            className="border-[#DED8D0] hover:bg-[#FAF8F5] text-xs uppercase tracking-wider h-10"
        ...
        <Card className="border-[#DED8D0] bg-white shadow-sm">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-2xl font-bold font-heading text-[#1A1A1A]">
        ...
        <Card className="border-[#DED8D0] bg-white shadow-sm">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-2xl font-bold font-heading text-[#1A1A1A] flex items-center">
              ...
              <Button
                ...
                className={`text-xs px-4 py-2 h-9 rounded-md transition-all shadow-none
                  ${statusFilter === status 
                    ...
                    : "border-[#DED8D0] hover:bg-[#FAF8F5] text-muted-foreground hover:text-[#1A1A1A]"}`}
          ...
          <TableBody>
            {filteredReturns.length === 0 ? (
              ...
              filteredReturns.map((ret) => (
                <TableRow key={ret.id} className="border-b border-[#DED8D0]/60 hover:bg-[#FAF8F5]/30 transition-all">
                  ...
                  <TableCell className="text-xs font-bold text-[#1A1A1A] font-heading">
      ...
      <Dialog open={selectedReturn !== null} onOpenChange={(open) => !open && setSelectedReturn(null)}>
        <DialogContent className="max-w-xl bg-white border-[#DED8D0] font-sans p-6 rounded-lg">
          <DialogHeader>
          ...
          {selectedReturn && (
            <div className="space-y-5 py-2">
              <div className="grid grid-cols-2 gap-4 bg-[#FAF8F5] p-4 rounded-lg border border-[#DED8D0] text-xs">
                <div>
              ...
              {/* Return Reason Card */}
              <div className="space-y-1 bg-rose-50/40 border border-rose-100 p-3.5 rounded-lg">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  className="w-full min-h-[80px] p-3 text-xs bg-white border border-[#DED8D0] rounded-md focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary shadow-none"
