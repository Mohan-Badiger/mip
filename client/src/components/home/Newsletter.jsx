          ...
          {submitted ? (
            ...
            >
              <input
                ...
                required
                className="flex-1 min-w-0 px-5 py-4 bg-white border border-brand-gold/30 sm:border-r-0 focus:border-brand-gold focus:outline-none text-brand-brown font-primary text-sm tracking-wide placeholder:text-gray-400/80 transition-colors"
              />
              <button
                type="submit"
                className="shrink-0 whitespace-nowrap bg-linear-to-r from-[#A68244] to-[#B89758] hover:from-brand-brown hover:to-[#5c4335] text-white font-primary text-xs font-semibold tracking-[0.18em] uppercase px-8 py-4 flex items-center justify-center gap-2 transition-all duration-300 group cursor-pointer"
              >
                Sign Up
