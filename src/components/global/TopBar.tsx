...
export default function TopBar() {
  return (
    <div className="bg-brand-brown text-white/90 text-xs py-2 px-4 md:px-8 flex justify-between items-center z-50 relative">
      <div className="flex gap-4 font-sans tracking-widest text-[10px] overflow-hidden whitespace-nowrap lowercase">
