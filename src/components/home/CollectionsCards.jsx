...
export default function CollectionsCards() {
  return (
    <section className="py-16 max-w-[1920px] mx-auto px-6 md:px-16 lg:px-24 border-t border-gray-100 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16 gap-y-16">
        {[
          ...
          <FadeInUp key={item.title} delay={idx * 0.1}>
            <div className="group cursor-pointer">
              <div className="relative h-[200px] md:h-[220px] w-full mb-4 overflow-hidden bg-gray-50">
                <Image
                  src={item.img}
                  alt={item.title}
                  fill
