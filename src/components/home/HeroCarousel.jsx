...
export default function HeroCarousel() {
  return (
    <div className="relative w-full h-[550px] md:h-[650px] bg-[#F8F3E6] overflow-hidden flex items-center">
        ...
        >
          ...
          <div className="relative mb-12">
            <div className="bg-[#B31D24] border-[3px] border-[#D8A452] shadow-xl relative z-10 px-8 py-3 md:px-16 md:py-4">
              <h2 className="font-serif text-3xl md:text-5xl text-white uppercase tracking-widest font-normal">
                New Schemes
              </h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 w-full max-w-4xl relative">
            ...
            <div className="flex flex-col items-center">
              <h3 className="font-serif text-4xl md:text-5xl text-brand-brown mb-6 font-medium tracking-wide">Kanaka Plus</h3>
              <p className="font-sans text-brand-brown text-base md:text-lg leading-relaxed max-w-[280px]">
                Invest once.<br />
            ...
            {/* Shreyas */}
            <div className="flex flex-col items-center">
              <h3 className="font-serif text-4xl md:text-5xl text-brand-brown mb-6 font-medium tracking-wide">Shreyas</h3>
              <p className="font-sans text-brand-brown text-base md:text-lg leading-relaxed max-w-[320px]">
